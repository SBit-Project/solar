...
func init() {
	cli := app.Command("prefund", "(sbit) fund an owner address with utxos")
	...
	appTasks["prefund"] = func() (err error) {
		...
		/*
			...
			2. "amounts"             (string, required) A json object with addresses and amounts
			    {
			      "address":amount   (numeric or string) The sbit address is the key, the numeric amount (can be string) in SBIT is the value
			      ,...
			    }
		*/
