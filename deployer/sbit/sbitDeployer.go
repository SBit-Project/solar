...
import (
	...
	"github.com/SBit-Project/solar/b58addr"
...
type Deployer struct {
	...
	*contract.ContractsRepository
	...
	// sbit base58 sender address used to create a contract.
...
func (d *Deployer) CreateContract(c *contract.CompiledContract, jsonParams []byte, opts *deployer.Options) (err error) {
	// TODO: dry out similar CreateContract code from eth and sbit deployers
	name := opts.Name
